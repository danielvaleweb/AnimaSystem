...
export function DecisionClaritySection({ onOpenDemoModal }: DecisionClaritySectionProps) {
  ...
  return (
    <section id="sobre" className="py-20 sm:py-28 bg-white border-b border-zinc-200/80 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            {/* Headline */}
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-[52px] font-['Urbanist'] font-bold text-zinc-950 tracking-tight leading-[1.12]">
            ...
            <div className="pt-2">
              <button
                ...
                className="inline-flex items-center justify-center px-8 py-3.5 bg-zinc-950 hover:bg-black text-white text-xs font-bold uppercase tracking-wider rounded-full shadow-sm hover:shadow-md transition-all cursor-pointer group"
              >
          ...
          >
            <div className="relative w-full max-w-md lg:max-w-none">
              <div className="overflow-hidden rounded-[32px] sm:rounded-[36px] bg-zinc-100 shadow-[0_20px_50px_rgba(0,0,0,0.12)] border border-zinc-200/70">
                <img
