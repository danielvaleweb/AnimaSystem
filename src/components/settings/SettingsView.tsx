  ...
  return (
    <div className="flex flex-col h-full space-y-14">
      ...
      <div className="flex gap-6 flex-1">
        ...
        {/* Content Area */}
        <div className="flex-1 bg-white border border-zinc-200/80 rounded-[2rem] p-6 lg:p-8 overflow-y-auto">
          ...
          {activeTab === 'integracao' && (
            <div className="space-y-10 max-w-4xl">
              ...
              {/* Diagram */}
              <div className="bg-white border border-zinc-200 rounded-2xl p-8 relative overflow-hidden">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-4">
                  {/* Master Node */}
                  <div className="bg-white border border-accent/30 rounded-xl p-5 w-full md:w-64 shadow-xl shadow-accent/5">
                    <h5 className="font-bold text-accent flex items-center gap-2 mb-4">
                      <Server className="w-4 h-4" />
                      AnimaSystem Master
                    </h5>
                    <div className="space-y-3">
                      <div className="flex items-center gap-2 text-xs text-zinc-700 bg-white rounded border border-zinc-200 p-2">
                  ...
                  <div className="flex flex-col items-center justify-center shrink-0">
                     ...
                     <div className="w-0.5 h-8 bg-zinc-200 md:hidden block my-2"></div>
                  </div>

                  {/* Client GCP Nodes Container */}
                  <div className="bg-white border border-zinc-300 rounded-xl p-5 w-full md:w-64 relative overflow-hidden">
                    <div className="absolute top-0 right-0 p-3 opacity-10">
                      <Lock className="w-16 h-16 text-zinc-100" />
                    </div>
                    <h5 className="font-bold text-zinc-800 flex items-center gap-2 mb-4 relative z-10">
                      <Database className="w-4 h-4" />
                      Client Projects
                    </h5>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-white border border-zinc-200 rounded-2xl p-5">
                    <h4 className="flex items-center gap-2 font-bold text-zinc-800 mb-3">
          ...
          {activeTab === 'geral' && (
            <div className="space-y-8 max-w-2xl">
              <div>
                ...
                <p className="text-zinc-500 text-sm">Personalize a aparência e funcionamento padrão da sua vitrine de serviços.</p>
              </div>

              <div className="bg-white border border-zinc-200 rounded-2xl p-6">
                <h4 className="flex items-center gap-2 font-bold text-zinc-800 mb-4">
                ...
                <div className="space-y-4">
                  {heroImage && (
                    <div className="relative w-full h-48 rounded-xl overflow-hidden mb-6 border border-zinc-200">
                  ...
                  <div className="flex gap-3">
                    <button 
                      ...
                      className="flex-1 flex items-center justify-center gap-2 bg-white hover:bg-zinc-100 border border-zinc-300 text-zinc-800 py-3 px-4 rounded-xl text-sm font-medium transition-colors cursor-pointer"
                    >
                  ...
                  <div className="flex items-center gap-2 bg-white border border-zinc-200 rounded-xl px-4 py-3">
              ...
              <div className="bg-white border border-zinc-200 rounded-2xl p-6">
                <h4 className="flex items-center gap-2.5 font-bold text-zinc-800 mb-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-blue-500/10 hover:bg-blue-600 border border-blue-500/20 text-blue-400 font-semibold py-3 px-4 rounded-xl text-xs transition-all cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-amber-500/10 hover:bg-amber-600 border border-amber-500/20 text-amber-400 font-semibold py-3 px-4 rounded-xl text-xs transition-all cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-rose-500/10 hover:bg-rose-600 border border-rose-500/20 text-rose-400 font-semibold py-3 px-4 rounded-xl text-xs transition-all cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-white hover:bg-zinc-100 border border-zinc-200 text-zinc-700 font-semibold py-3 px-4 rounded-xl text-xs transition-all cursor-pointer"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-2 bg-white hover:bg-zinc-100 text-black font-bold py-3 px-4 rounded-xl text-xs transition-all cursor-pointer"
                  >
