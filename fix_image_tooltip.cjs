...
const oldStr = `          <div className="flex items-center gap-5">
            <div className="w-16 h-16 rounded-2xl bg-white border border-zinc-300 flex items-center justify-center text-2xl font-display font-medium text-zinc-700 overflow-hidden" title={client.name}>
              {client.logoUrl ? (
...
const newStr = `          <div className="flex items-center gap-5">
