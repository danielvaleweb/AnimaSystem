...
const oldHeaderStr = `    <div className="flex flex-col h-full space-y-6 relative">
      
      
      <div className="flex flex-col sm:flex-row justify-end gap-3">`;

const newHeaderStr = `    <div className="flex flex-col h-full space-y-6 relative">
